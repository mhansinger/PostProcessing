...
def radial_samples_reacting(case_path):
    ...
    try:
        scalarTail = '_f_BilgerMean_f_BilgerPrime2Mean_TMean_TPrime2Mean_CH4Mean_CH4Prime2Mean_H2OMean_H2OPrime2Mean_CO2Mean_CO2Prime2Mean_O2Mean_O2Prime2Mean_COMean_COPrime2Mean_H2Mean_H2Prime2Mean.xy'
		    # '_f_BilgerMean_f_BilgerPrime2Mean_TMean_TPrime2Mean_CH4Mean_CH4Prime2Mean_H2OMean_H2OPrime2Mean_CO2Mean_CO2Prime2Mean_O2Mean_O2Prime2Mean_COMean_COPrime2Mean_H2Mean_H2Prime2Mean.xy'
            # '_f_BilgerMean_f_BilgerPrime2Mean_TMean_TPrime2Mean_CH4Mean_' \
    ...
    for n in range(0, len(nLocation)):
        ...
        Output_df.columns = ['r_in_m', 'Z_mean', 'T_mean','Y_CH4_mean','Y_H2O_mean','Y_CO2_mean','Y_O2_mean','Y_CO_mean',
                 'Y_H2_mean','U_axial_mean','U_radial_mean','U_teta_mean','Z_rms','T_rms','Y_CH4_rms','Y_H2O_rms',
                 'Y_CO2_rms','Y_O2_rms','Y_CO_rms','Y_H2_rms','U_axial_rms','U_radial_rms','U_teta_rms',
