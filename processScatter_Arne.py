...
# falls keinen Bock darauf: von Zeile 50 bis 73 auskommentieren
...
# plots
#############################################
def plotData(spec='T',sampleSize=14000):
...
def plotDataColorPlane(spec='T',plane=0,color_by='T',colormap='inferno',sampleSize=14000):
    # creates a scatter plot of the defined species over the mixture fraction
    plt.close('all')
    # loop over the different planes:
    i=plane
...
def plotCompare(spec='T',sampleSize=14000):
    # creates a scatter plot of the defined species over the mixture fraction
    if spec == 'T':
        specE = 'Tray'
    else:
...
def plotDataPlane(spec='T',plane=3,sampleSize=14000):
    # creates a scatter plot of the defined species over the mixture fraction
    i=plane
    # loop over the different planes:
    try:
...
def plotDataPlaneExp(spec='Tray',sampleSize=14000):
    # creates a scatter plot of the defined species over the mixture fraction
    plt.close('all')
...
def plotDataPlaneExpColor(spec='Tray', color_by='Tray', colormap='inferno', sampleSize=14000):
    # creates a scatter plot of the defined species over the mixture fraction
    plt.close('all')
...
def getBurningIndexSim(spec='T',sampleSize=1000,f_min=0.05,f_max=0.06,bins=50):
    # creates a scatter plot of the defined species over the mixture fraction
    plt.close('all')
    #
    # if spec == 'CO':
    ...
    for i in range(0,7):
        ...
        this_BI = (thisSim_reduced['T'].mean() - 300)/ (2100 - 300)
...
def getBurningIndexExp(spec='T',sampleSize=1000,f_min=0.05,f_max=0.06,bins=50):
    # creates a scatter plot of the defined species over the mixture fraction
    plt.close('all')
    #
    # if spec == 'CO':
    ...
    for i in range(0,7):
        ...
        this_BI = (thisSim_reduced['Tray'].mean() - 300) / (2100 - 300)
