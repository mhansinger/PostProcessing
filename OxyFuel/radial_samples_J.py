...
#        scalarTail = '_J_lamMean_J_sgsMean_J_H2Mean_J_H2_sgsMean_J_HMean_J_H_sgsMean_J_O2Mean_J_O2_sgsMean_J_H2OMean_J_H2O_sgsMean_J_CH4Mean_J_CH4_sgsMean_J_CO2Mean_J_CO2_sgsMean.xy'
        scalarTail='_J_CH4Mean_J_H2Mean_J_CO2Mean_J_H2OMean_J_sgsMean_J_lamMean.xy'
    except:
    ...
    for n in range(0, len(nLocation)):
        ...
        for time in times:
            for j in range(0, noFiles):
                ...
                dataScalar = np.loadtxt(case_path+'/postProcessing/sampleDict_J_D/' + time + '/line_x'+str(nLocation[n]) + '-r' + str(j) + scalarTail)
        ...
        output_name = case_path+'/postProcessing/sampleDict_J_D/' + 'line_xD' + location_dict[n] + '_J_Oxy.txt'
